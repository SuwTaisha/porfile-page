...
export default function Home() {
    ...
    useEffect(() => {
        async function getData() {
            ...
            const commitArr: repository[] = fetchedData.commitContributionsByRepository;
            ...
            <div className="w-4/5 m-auto xl:block hidden profile">
                ...
                >
                    ...
                    >
                        ...
                        {data.map((content, index) => (
                            <Fragment key={index}>
                                <p className={`[-webkit-text-stroke:1px_black] line-clamp-2 ${cherryBomb.className} text-stroke text-white`}>{content.bio_1}</p>
                                <br />
                                <p className={`[-webkit-text-stroke:1px_black] line-clamp-2 ${cherryBomb.className} text-stroke text-white`}>{content.bio_2}</p>
                                <br />
                                <p className={`[-webkit-text-stroke:1px_black] line-clamp-2 ${cherryBomb.className} text-stroke text-white`}>{content.bio_3}</p>
                            </Fragment>
                        ))}
                    </div>
                    {/* Favorite Musics */}
                ...
                >
                    ...
                    >
                        ...
                        <p className="[-webkit-text-stroke:1px_black] text-white  line-clamp-3">{pageData?.additional_1}</p>
                        <p className="[-webkit-text-stroke:1px_black] text-white  line-clamp-4">{pageData?.additional_2}</p>
                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <ul className="text-white list-disc ">
                                <li className="mx-0 ml-6 [-webkit-text-stroke:1px_black]">{pageData?.life_1}</li>
                                <li className="mx-0 ml-6 [-webkit-text-stroke:1px_black]">{pageData?.life_2}</li>
                            </ul>
                        </div>
                        ...
                        >
                            ...
                            <ul className="text-white list-disc ">
                                <li className="mx-0 ml-4 [-webkit-text-stroke:1px_black]">{pageData?.series_1}</li>
                                <li className="mx-0 ml-4 [-webkit-text-stroke:1px_black]">{pageData?.series_2}</li>
                                <li className="mx-0 ml-4 [-webkit-text-stroke:1px_black]">{pageData?.series_3}</li>
                            </ul>
                        </div>
                    </div>
